...
import com.example.playlist_maker_android_trubitsindanil.data.SearchHistoryRepositoryImpl
    ...
    private fun performSearch(request: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                val list = trackSearchInteractor.searchTracks(expression = request)
        ...
        fun getViewModelFactory(): ViewModelProvider.Factory =
            object : ViewModelProvider.Factory {
                ...
                override fun <T : ViewModel> create(modelClass: Class<T>): T {
                    return SearchViewModel(Creator.getTrackSearchInteractor()) as T
                }
            }
    }
}